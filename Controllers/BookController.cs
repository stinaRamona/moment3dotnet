...
namespace moment3dotnet.Controllers
{
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Read,GenreModelId")] BookModel bookModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Read,GenreModelId")] BookModel bookModel)
        {
            if (id != bookModel.Id)
            {
                return NotFound();
